...
//params.id == params comes from the file name. If the file name was blog_id, then it will be param.blog_id. Basically, param.<fileName>
export async function getServerSideProps({ params }) {
    console.log("API_URL: ", process.env.APIURL)
    const res = await fetch(`${process.env.API_URL}/blogs/articles/${params.id}`)
